/******************************************************************************/
/*                                                                            */
/* Name: dac_sfcn_9S12 - S-Function producing analogue o/p (using DAC0/DAC1)  */
/*                                                                            */
/* fw-03-05                                                                   */
/******************************************************************************/
...
#define S_FUNCTION_NAME  dac_sfcn_9S12
...
// this is only required if the format of the call-up parameters is modified... (FW-06-01)
   ...
   #include "simulink.c"
#else
# error "Attempt to use dac_sfcn_9S12.c as non-inlined S-function"
#endif
