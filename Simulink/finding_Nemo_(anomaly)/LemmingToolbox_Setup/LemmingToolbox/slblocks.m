...
%
blkStruct.Name = 'E. lemming';

%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'LemmingToolbox';
...
%
Browser(1).Library = 'LemmingToolbox';
Browser(1).Name    = 'LemmingToolbox';
...
addpath(fullfile(matlabroot,'/toolbox/LemmingToolbox'));
savepath
% End of slblocks
