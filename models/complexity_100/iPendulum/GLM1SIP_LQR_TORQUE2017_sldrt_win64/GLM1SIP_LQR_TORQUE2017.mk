...
MODEL                := GLM1SIP_LQR_TORQUE2017
MODULES              := GLM1SIP_LQR_TORQUE2017_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := GLM1SIP_LQR_TORQUE2017.mk
...
#
MODELLIB                  := GLM1SIP_LQR_TORQUE2017lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := GLM1SIP_LQR_TORQUE2017_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/elec3200/Desktop/lqrctrl/GLM1SIP_LQR_TORQUE2017_sldrt_win64;C:/Users/elec3200/Desktop/lqrctrl;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
