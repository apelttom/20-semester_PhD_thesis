 ...
 *
 * File    : extsim.h     $Revision: 1.13.6.9 $
 * Abstract:
...
struct ExternalSim_tag {
    ...
    uint32_T   hostMWChunkSize;        /* Chunk size in bytes for Multiword
                                        * data types. */
    ...
    struct {
        ...
        uint32_T *dataTypeSizes; /* Size (on the target, in target bytes) of
                                  ...
                                  */
        uint32_T targetMWChunkSize;  /* Chunk size in bytes for Multiword data
                                      * types. */
        ...
        TargetToHostDataTypeFcn  int33PlusTargetToHostFcn;
        HostToTargetDataTypeFcn  int33PlusHostToTargetFcn;
...
#define esSetHostMWChunkSize(ESim, val)  ((ESim)->hostMWChunkSize = (val))
#define esGetHostMWChunkSize(ESim)  ((ESim)->hostMWChunkSize)

#define esSetTargetMWChunkSize(ESim, val)  ((ESim)->TargetDataInfo.targetMWChunkSize = (val))
#define esGetTargetMWChunkSize(ESim)  ((ESim)->TargetDataInfo.targetMWChunkSize)
...
#define esSetInt33PlusTargetToHostFcn(ESim, fcn) \
    ((ESim)->TargetDataInfo.int33PlusTargetToHostFcn = (fcn))

#define esSetInt33PlusHostToTargetFcn(ESim, fcn) \
    ((ESim)->TargetDataInfo.int33PlusHostToTargetFcn = (fcn))
...
#define esGetInt33PlusTargetToHostFcn(ESim) \
    ((ESim)->TargetDataInfo.int33PlusTargetToHostFcn)

#define esGetInt33PlusHostToTargetFcn(ESim) \
    ((ESim)->TargetDataInfo.int33PlusHostToTargetFcn)
