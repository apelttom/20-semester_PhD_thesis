 ...
 *
 * File    : rt_sim.c     $Revision: 1.19.4.8 $
 * Abstract:
                                   ...
                                   void        **rtmTimingDataPtr)
{
    ...
    /* In the ERT_CORE case this function does nothing */
...
#endif
{
    ...
    /* The ERT_CORE version of this function does nothing */
...
#ifndef ERT_CORE
/* This function is not defined here if ERT_CORE is set */
...
{
#ifdef ERT_CORE
    /* This function is a no-op in ERT_CORE */
    UNUSED_PARAMETER(rtmTPtr);
    UNUSED_PARAMETER(rtmTimingData);
