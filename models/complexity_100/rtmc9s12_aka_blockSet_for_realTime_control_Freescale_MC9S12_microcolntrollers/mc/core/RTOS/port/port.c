...
static void prvSetupTimerInterrupt( void ) {
    ...
    /* 
	 * initialize RTI unit for the configured tick rate (bsp_cfg.h)
	 * sample time is set to 1/fTickRateHz --> ISR user function
	 * (app_rti_UsrFnc) is run at every RTI tick
	 */
    RTI_Init( 1.F / configTICK_RATE_HZ );
