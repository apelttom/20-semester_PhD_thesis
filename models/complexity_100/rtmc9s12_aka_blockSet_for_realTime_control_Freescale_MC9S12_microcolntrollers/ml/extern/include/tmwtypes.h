...
/* 
 * modified "rtiostream_interface.c" now refers to "long_T" (instead of "long")
 * fw-04-10
 */
typedef long           long_T;
...
/* ------------------------------------------------------------------------- */
/* prescribe data types as used on the chosen micro controllers  -  fw-04-10 */
/* ------------------------------------------------------------------------- */

#ifndef TARGET_CPU_FAMILY
 /* HW dependent constants -- generated by 'gen_mc_defines_h.m' */
 #include "mc_hw_defines.h"
#endif


/* Infineon C167, Keil C166 */
#if TARGET_CPU_FAMILY == BSP_C167
...
#undef INTEGER_T
#define INTEGER_T signed int

#undef UINTEGER_T
#define UINTEGER_T unsigned int
...
#endif  /* TARGET_CPU_FAMILY == BSP_C167 */


/* Freescale mc9s12, Metrowerks CodeWarrior */
#if TARGET_CPU_FAMILY == BSP_MC9S12
...
#endif  /* TARGET_CPU_FAMILY == BSP_MC9S12 */
...
#   define REAL64_T float       /* on the micros  --  fw-08-07 */
#  endif
# else
//#   define REAL64_T double
#   define REAL64_T float       /* on the micros  --  fw-08-07 */
...
/*
 * moved to here from rtwtypes.h to ensure these definitions are always available.
 * fw-07-10
 */
#ifndef POINTER_T
# define POINTER_T
