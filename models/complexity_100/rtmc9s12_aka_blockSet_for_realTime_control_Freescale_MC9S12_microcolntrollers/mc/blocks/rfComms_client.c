/******************************************************************************/
/*                                                                            */
/* Name: rfComms_client.c  - S-Function for the communication using the       */
/*                           nRF24L01 radio module - client side              */
/*                                                                            */
/******************************************************************************/
...
#define S_FUNCTION_NAME rfComms_client
...
// this is only required if the format of the call-up parameters is modified... (FW-06-01)
   ...
   #include "simulink.c"
#else
# error "Attempt to use rfComms_client.c as non-inlined S-function"
#endif
